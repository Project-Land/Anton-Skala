<x-app-layout>
    ...
    <x-slot name="title">| {{ __('Kreiranje nastavničkog naloga') }}</x-slot>
    ...
    <div class="container px-6 mx-auto grid">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-2">
            <h2 class="my-3 md:my-6 text-lg md:text-2xl font-semibold text-gray-700 dark:text-gray-200">{{ __('Kreiranje nastavničkog naloga') }}</h2>
        ...
        <div class="relative w-full sm:w-1/2 overflow-x-auto shadow-md sm:rounded-lg bg-white dark:bg-gray-800">
            ...
            <form class="p-4" method="POST" action="{{ route('teachers.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <select name="lang" id="lang" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500" required>
                        ...
                        <option value="cro" {{ old('lang')=='cro' ? "selected" :"" }}>{{ __('Hrvatski') }}</option>
