<x-app-layout>
    ...
    <div class="container px-6 lg:px-32 mb-8 mx-auto grid">
        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800" x-data="{ show: false }">
            <form action="{{ route('tasks.store-column-sorting-type') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex space-x-8" x-show="show">
                    <img class="w-full sm:w-1/3 p-4 border border-gray-500 rounded-lg mt-2" src="/images/column_sorting1.png" alt="prevlacenje_po_kolonama">
                    <img class="w-full sm:w-1/3 p-4 border border-gray-500 rounded-lg mt-2" src="/images/column_sorting2.png" alt="prevlacenje_po_kolonama">
                </div>
            </form>
        </div>
    </div>
