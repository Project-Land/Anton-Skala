<x-app-layout>
    ...
    <div class="container px-6 lg:px-32 mb-8 mx-auto grid">
        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800" x-data="{ show: false }">
            <form action="{{ route('tasks.store-column-sorting-multiple-type') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <!-- Kolone -->
                <div class="mb-6">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('Kolone') }}</label>
                ...
                <div class="flex space-x-8" x-show="show">
                    <img class="w-full sm:w-1/3 p-4 border border-gray-500 rounded-lg mt-2" src="/images/column_sorting_multiple1.png" alt="prevlacenje_po_kolonama">
                    <img class="w-full sm:w-1/3 p-4 border border-gray-500 rounded-lg mt-2" src="/images/column_sorting_multiple2.png" alt="prevlacenje_po_kolonama">
                </div>
            </form>
        </div>
    </div>
