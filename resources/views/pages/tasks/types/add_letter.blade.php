<x-app-layout>
    ...
    <div class="container px-6 lg:px-32 mx-auto grid">
            ...
            <form action="{{ route('tasks.store-add-letter-type') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6" x-data="imageViewer()">
                    ...
                    <div class="border border-purple-600 rounded-lg p-4 grid grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="file_input">{{ __('Opis zadatka') }}</label>
                            <input type="text" name="description" id="" value="{{ old('description') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500">
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="file_input">{{ __('Tekst - u zagradama staviti slova koja treba da se dodaju ( TR(A)VA )') }}</label>
        ...
        <div>
            ...
            <img class="w-full sm:w-1/3" src="/images/add_letter.png" alt="dodavanje slova">
        </div>
    </div>
