    ...
    <div class="container px-6 lg:px-32 mb-8 mx-auto grid">
        ...
        <div class="flex items-center justify-between">
            <h2 class="my-6 text-lg md:text-xl font-semibold text-gray-700 dark:text-gray-200">
                {{ __('Jedan ili više tačnih odgovora') }} - {{ __('Kreiranje') }}
            </h2>
        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800" x-data="{ show: false }">
            <form action="{{ route('tasks.store-correct-answer-type') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6" x-data="imageViewer()">
                    ...
                    <div class="border border-purple-600 rounded-lg p-4 grid grid-rows sm:grid-cols-3 gap-6">
                        <div>
                        ...
                        <div class="inline-flex sm:border-l-2 sm:border-r-2 sm:px-6">
                            <div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-rows-1 gap-8 border rounded-lg p-4">
                        ...
                        <template id="template">
                            <div class="border border-violet-300 rounded-lg p-4 grid grid-rows-1 sm:grid-cols-12 gap-6" x-data="imageViewer()">
                ...
                <div class="flex" x-show="show">
                    <img class="w-full sm:w-1/3 p-4 border border-gray-500 rounded-lg mt-2" src="/images/correct_answer.png" alt="tacan_odgovor">
                </div>
            </form>
        </div>
    </div>
