    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul>
            <li class="relative px-6 py-3">
                ...
                @endif
                <a class="{{ request()->is('subjects')? " text-purple-800 dark:text-purple-400":"" }} inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-purple-800 dark:hover:text-gray-200" href="{{ route('subjects.index') }}">
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="{{ request()->is('students')? " text-purple-800 dark:text-purple-400":"" }} inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-purple-800 dark:hover:text-gray-200" href="{{ route('students.index') }}">
                    ...
                    <span class="ml-4">{{ __('Učenici') }}</span>
                </a>
            </li>
            ...
            <li class="relative px-6 py-3">
                ...
                <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                @endif
                <a class="{{ request()->is('teachers')? " text-purple-800 dark:text-purple-400":"" }} inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-purple-800 dark:hover:text-gray-200" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-purple-600 dark:text-purple-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                    </svg>
                    <span class="ml-4">{{ __('Nastavnici') }}</span>
                </a>
            </li>
        </ul>
    </div>
