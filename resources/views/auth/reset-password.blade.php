    ...
    <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
        <div class="flex flex-col overflow-y-auto md:flex-row">
            <div class="h-32 md:h-auto md:w-1/2">
                ...
                <img aria-hidden="true" class="hidden object-cover w-full h-full dark:block" src="{{ asset('images/forgot-password-dark.jpeg') }}" alt="School" />
            </div>
                ...
                <div class="w-full">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <label class="block mt-4 text-sm">
                            <span class="text-gray-700 dark:text-gray-400">{{ __('Nova lozinka') }}</span>
                        ...
                        <label class="block mt-4 text-sm">
                            <span class="text-gray-700 dark:text-gray-400">{{ __('Potvrdite novu lozinku') }}</span>
                            <input id="password_confirmation" class="block w-full mt-1 text-sm appearance-none border border-gray-200 dark:border-gray-600 dark:bg-gray-700 rounded py-2 px-3 text-gray-700 mb-3 leading-tight focus:border-purple-400 focus:outline-none focus:shadow-outline-gray dark:text-gray-300 dark:focus:shadow-outline-gray" type="password"
